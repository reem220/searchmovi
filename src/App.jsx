...
function App() {
 ...
 const search_url=`https://api.themoviedb.org/3/search/movie?api_key=d7835d06aa9bf95f73ab15509e7dc769&query=`;
...
const serschmovi= async (value)=>{
const res =await axios.get(`${search_url}`+ value)
...
<nav className="navbar">
        <div className="inner">
          ...
          <div className="navright">
            ...
            />
            <button className="right" style={{ alignSelf: "flex-end" }} onClick={()=>serschmovi(serch)} >Search</button>
          </div>
        </div>
      </nav>
